...
public enum UpdateNotificationStatusRequest {
    ACKNOWLEDGED,
    ACCEPTED,
    DECLINED;
    ...
    @JsonCreator
    public static UpdateNotificationStatusRequest fromValue(final String value) {
        return Stream.of(UpdateNotificationStatusRequest.values())
    ...
    private static String supportedUpdateInvestigationStatus() {
        return Stream.of(UpdateNotificationStatusRequest.values()).map(Enum::name).collect(Collectors.joining(", "));
    }
