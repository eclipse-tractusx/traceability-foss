...
import static net.catenax.traceability.config.security.KeycloakRole.ADMIN
import static net.catenax.traceability.config.security.KeycloakRole.SUPERVISOR
import static net.catenax.traceability.config.security.KeycloakRole.USER
