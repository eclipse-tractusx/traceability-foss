...
export { ChildTableComponent } from './components/table/child-table/child-table.component';
export { RowDetailDirective } from './components/table/row.detail.directive';
export { Table } from './components/table/table';
export { TableConfig } from './components/table/table-config';
export { TableFactory } from './components/table/table-factory';
export { TableComponent } from './components/table/table.component';
export { TableFacade } from './components/table/table.facade';
export { TableState } from './components/table/table.state';
...
export { AssetDatePipe } from './pipes/asset-date.pipe';
export { DateSplitPipe } from './pipes/date-split.pipe';
...
export { icons } from './shared-icons.module';
