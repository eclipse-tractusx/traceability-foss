...
package net.catenax.traceability.infrastructure.edc.blackbox.negotiation;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonTypeName;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder;
import net.catenax.traceability.infrastructure.edc.blackbox.agreement.ContractAgreement;
...
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.CONFIRMED;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.CONFIRMING;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.CONSUMER_APPROVED;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.CONSUMER_APPROVING;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.CONSUMER_OFFERED;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.CONSUMER_OFFERING;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.DECLINED;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.DECLINING;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.INITIAL;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.PROVIDER_OFFERED;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.PROVIDER_OFFERING;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.REQUESTED;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.REQUESTING;
import static net.catenax.traceability.infrastructure.edc.blackbox.negotiation.ContractNegotiationStates.UNSAVED;
