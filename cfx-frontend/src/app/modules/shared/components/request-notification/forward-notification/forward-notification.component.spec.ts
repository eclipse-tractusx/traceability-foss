...
describe('ForwardNotificationComponent', () => {
  ...
  let componentInstance: ForwardNotificationComponent;
  let fixture: ComponentFixture<ForwardNotificationComponent>;


  beforeEach(async () => {
    fixture = (await renderForwardNotificationComponent()).fixture;
  ...
  const renderForwardNotificationComponent = () => {
    return renderComponent(ForwardNotificationComponent, {
      declarations: [ForwardNotificationComponent, InputComponent, SupplierPartsComponent],
