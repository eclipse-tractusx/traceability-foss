...
describe('NotificationUserComponent', () => {
  ...
  const renderUser = (user: NotificationUser = {
    bpn: defaultNotification.createdBy,
    name: defaultNotification.createdByName,
  }) => {
  ...
  it('should render user name and number from sendTo', async () => {
    await renderUser({ bpn: defaultNotification.sendTo, name: defaultNotification.sendToName });
