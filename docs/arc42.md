...
For detailed information about the API model, please refer to the [API specification](https://catenax-ng.github.io/tx-traceability-foss/docs/api-specification/api-specification.html).
