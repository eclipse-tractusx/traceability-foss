...
**Note**:
For more detailed information concering the functionality of IRS please refer to [IRS docu](https://eclipse-tractusx.github.io/item-relationship-service/docs/)
