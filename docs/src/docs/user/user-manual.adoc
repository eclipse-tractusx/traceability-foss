...
image::https://raw.githubusercontent.com/eclipse-tractusx/tx-traceability-foss/main/docs/src/images/usermanual/app_roles.png[]
...
image::https://raw.githubusercontent.com/eclipse-tractusx/tx-traceability-foss/main/docs/src/images/usermanual/assign_app_roles.png[]

=== Catena-X portal roles

Role details: https://portal.int.demo.catena-x.net/role-details

image::https://raw.githubusercontent.com/eclipse-tractusx/tx-traceability-foss/main/docs/src/images/usermanual/cx_portal_roles.png[]
