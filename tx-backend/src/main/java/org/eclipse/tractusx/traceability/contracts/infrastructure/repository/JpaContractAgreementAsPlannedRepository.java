...
@Repository
public interface JpaContractAgreementAsPlannedRepository extends JpaRepository<ContractAgreementAsPlannedEntity, String>, JpaSpecificationExecutor<ContractAgreementAsPlannedEntity> {
