...
public class TestContractDefinitionService extends EdcContractDefinitionService {
    ...
    public EdcCreateContractDefinitionRequest createContractDefinitionRequest(String assetId, String accessPolicyId) {
        ...
        return EdcCreateContractDefinitionRequest.builder().contractPolicyId(accessPolicyId).edcContext(edcContext).type("ContractDefinition").accessPolicyId(accessPolicyId).contractDefinitionId(UUID.randomUUID().toString()).assetsSelector(edcContractDefinitionCriteria).build();
    }
}
