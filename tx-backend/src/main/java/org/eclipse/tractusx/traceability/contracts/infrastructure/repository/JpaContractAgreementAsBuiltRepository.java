...
@Repository
public interface JpaContractAgreementAsBuiltRepository extends JpaRepository<ContractAgreementAsBuiltEntity, String>, JpaSpecificationExecutor<ContractAgreementAsBuiltEntity> {
