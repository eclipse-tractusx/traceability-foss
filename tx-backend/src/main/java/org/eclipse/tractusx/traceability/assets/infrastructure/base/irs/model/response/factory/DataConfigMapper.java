...
public class DataConfigMapper implements AssetBaseMappers<List<ImportRequest.AssetImportRequest>> {
        ...
        assetImportRequestList.forEach(assetImportRequest -> {
            ...
            List<AssetBase> mainSubmodels = submodels.stream().map(irsSubmodel -> {
                ...
                if (mapper.isPresent()) {
                    ...
                    assetBase.setOwner(getOwner(assetBase, traceabilityProperties));
