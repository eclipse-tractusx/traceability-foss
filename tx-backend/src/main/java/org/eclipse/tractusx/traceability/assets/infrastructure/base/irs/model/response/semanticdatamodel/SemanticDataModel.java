...
public class SemanticDataModel {
    ...
    public AssetBase toDomainAsBuiltLight(List<Descriptions> parentRelations, List<Descriptions> childRelations,
                                          List<DetailAspectDataTractionBatteryCode> detailAspectDataTractionBatteryCodes) {
        ...
        return AssetBase.builder()
                .id(catenaXId())
                // only in shell object existing basically just a trim of the nameAtManufacturer
                // .idShort(defaultValue(shortIds.get(catenaXId())))
                .semanticModelId(semanticModelId.get())
                .detailAspectModels(detailAspectModels)
                .manufacturerId(manufacturerId())
                // we dont have the manufacturername
                //.manufacturerName(defaultValue(manufacturerName))
                .nameAtManufacturer(partTypeInformation.nameAtManufacturer())
                .manufacturerPartId(partTypeInformation.manufacturerPartId())
                .parentRelations(parentRelations)
    ...
    public AssetBase toDomainAsPlannedLight(
