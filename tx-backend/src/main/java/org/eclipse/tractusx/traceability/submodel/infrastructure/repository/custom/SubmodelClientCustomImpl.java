...
public class SubmodelClientCustomImpl implements SubmodelClient {

    private final RestTemplate submodelRestTemplate;

    public SubmodelClientCustomImpl(@Qualifier(SUBMODEL_REST_TEMPLATE) RestTemplate submodelRestTemplate) {
