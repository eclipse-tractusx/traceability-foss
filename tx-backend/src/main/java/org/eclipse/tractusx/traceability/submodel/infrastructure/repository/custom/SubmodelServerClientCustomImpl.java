...
package org.eclipse.tractusx.traceability.submodel.infrastructure.repository.custom;
...
import org.eclipse.tractusx.traceability.submodel.infrastructure.repository.SubmodelClient;
...
@Slf4j
@ConditionalOnProperty(name = "provisioning.submodel.use-custom-implementation", havingValue = "true")
public class SubmodelServerClientCustomImpl implements SubmodelServerRepository {
    ...
    public String saveSubmodel(SubmodelCreateRequest submodelCreateRequest) {
        String submodelId;
        try {
            String submodelEnriched = SubmodelUtil.enrichWithSubmodelUuid(objectMapper, submodelCreateRequest.getSubmodel());
