...
public class NotificationSpecification extends BaseSpecification<NotificationEntity> implements Specification<NotificationEntity> {

    public NotificationSpecification(SearchCriteriaFilter criteriaFilter) {
        super(criteriaFilter);
    }

    @Override
    public Predicate toPredicate(@NotNull Root<NotificationEntity> root, @NotNull CriteriaQuery<?> query, @NotNull CriteriaBuilder builder) {
