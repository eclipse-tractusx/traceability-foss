...
public enum NotificationStatusBaseEntity {
    ...
    static {
        ...
        MAPPINGS = Arrays.stream(NotificationStatusBaseEntity.values())
                .collect(Collectors.toMap(Enum::name, notificationStatusBaseEntity -> notificationStatusBaseEntity));
    }
    ...
    public static NotificationStatusBaseEntity from(NotificationStatus status) {
        return NotificationStatusBaseEntity.valueOf(status.name());
    }

    public static List<NotificationStatusBaseEntity> from(List<NotificationStatus> statuses) {
