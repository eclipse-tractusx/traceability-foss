...
@Slf4j
public class RegisterOrderJobRegistration implements CronJobRegistration {
    ...
    public String getCronExpression(Config config) {
        return config.getTriggerConfiguration().getCronExpressionRegisterOrderTTLReached();
    }
