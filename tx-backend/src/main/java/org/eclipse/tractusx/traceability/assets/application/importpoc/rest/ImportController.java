...
public class ImportController {
    ...
    @Operation(operationId = "policyById",
            summary = "Get policy by id",
            tags = {"AssetsImport"},
            description = "The endpoint returns an policy filtered by id .",
            security = @SecurityRequirement(name = "oAuth2", scopes = "profile email"))
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Returns the policy found",
    ...
    public PolicyResponse policy(@PathVariable String policyId) {
        return PolicyResponseMapper.from(importService.getPolicyById(policyId));
    }
