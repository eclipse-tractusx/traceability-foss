...
values
    (${investigationId2}, 'BPNL000CUSTOMER1', null        , current_timestamp - interval '2 hours', 'Investigation on Xenon Right-Headlights due to malfunction.', 'ACKNOWLEDGED', 'RECEIVER', null         , null          , current_timestamp - interval '1 hours', null);
...
values
    (${investigationNotificationId2a}, ${assetAsBuiltId02});
...
values
    (${investigationId2}, ${assetAsBuiltId02});
...
insert into investigation_notification
    (id                              , contract_agreement_id, edc_url                                                 , notification_reference_id, send_to           , created_by        , investigation_id   , target_date                          , severity, created_by_name, send_to_name, edc_notification_id                   , status, created                               , updated                              , message_id                            , is_initial)
values
    (${investigationNotificationId2b}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', null                     , 'BPNL000CUSTOMER1', 'BPNL000000000001', ${investigationId2}, current_timestamp + interval '1 week', 1       , 'Hella'        , 'BMW AG'    , '8925f21f-09eb-4789-81fb-ec221e9e1561', '3'   , current_timestamp - interval '2 hours', current_timestamp - interval '1 hour', '207ba6cf-217b-401d-a5da-69cac8b154a5', false);
...
insert into assets_as_built_notifications
    (notification_id                 , asset_id)
values
    (${investigationNotificationId2b}, ${assetAsBuiltId02});
