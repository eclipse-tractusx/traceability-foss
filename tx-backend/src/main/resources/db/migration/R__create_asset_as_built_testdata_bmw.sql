DO $$
    ...
    BEGIN
        IF applicationBpn = '${bpnB}' AND '${applyTestData}' = true THEN
            ...
            INSERT INTO assets_as_built (
                id, customer_part_id, id_short, manufacturer_id, manufacturer_name, manufacturer_part_id, manufacturing_country, name_at_customer, name_at_manufacturer, quality_type, van, owner, semantic_model_id, semantic_data_model, classification, product_type, manufacturing_date, import_state, import_note, policy_id, tombstone, contract_agreement_id, digital_twin_type
                  ...
                  ('urn:uuid:0bb07747-9774-47a7-bcb7-6c4388745585', NULL, '0bb07747-9774-47a7-bcb7-6c4388745585', bpnB, 'BMW', 'NA5', 'HUN', NULL, 'iX3 50 xDrive', 'OK', 'AAIdj5ckUAhZG5APOIZ2qU0Vm3CLnFitv4Pl6lfVLu4WWyobqW+k+8nL/N1y7vJklwYpSRglSTWaXH1Vs2eKnPgNZx246nbAKi6q2Obb4+gaD1abKT0=', 'OWN', 'AAIdj5ckUAhZG5APOIZ2qU0Vm3CLnFitv4Pl6lfVLu4WWyobqW+k+8nL/N1y7vJklwYpSRglSTWaXH1Vs2eKnPgNZx246nbAKi6q2Obb4+gaD1abKT0=', 'SERIALPART', 'product', NULL, '2024-12-05T00:00:00.000Z', 'PERSISTENT', 'Asset successfully created in the system.', 'default_policy', NULL, 'CONTRACT_AGR_001', 'partType'),
                  ('urn:uuid:8ea0e758-af77-4932-8f09-724f14ca7125', NULL, '8ea0e758-af77-4932-8f09-724f14ca7125', bpnB, 'BMW', 'G61', 'DEU', NULL, 'i5 eDrive40', 'OK', 'AAJPS0UcJ5hAJKVz4IbOTRIClUYayOfzgCI76wzS+j5pS6x+nFAWlPT5VNTY7Boi7MSeC6Z2RxMgaoeV/hk+omlfuN3QB7vjl3LbgTPW0vql4QuuSB8=', 'OWN', 'AAJPS0UcJ5hAJKVz4IbOTRIClUYayOfzgCI76wzS+j5pS6x+nFAWlPT5VNTY7Boi7MSeC6Z2RxMgaoeV/hk+omlfuN3QB7vjl3LbgTPW0vql4QuuSB8=', 'SERIALPART', 'product', NULL, '2024-12-17T00:00:00.000Z', 'PERSISTENT', 'Asset successfully created in the system.', 'default_policy', NULL, 'CONTRACT_AGR_001', 'partType'),
                  ('urn:uuid:94617c47-692f-40e6-ac15-75dca036477b', NULL, '94617c47-692f-40e6-ac15-75dca036477b', bpnB, 'BMW', 'NA5', 'HUN', NULL, 'iX3 50 xDrive', 'OK', 'AAMfUf4bMP1ThymoWYhNAylZuM0S7vZvvElWkKaBcHoMVuRvR1YtpIZnxERNX+Gd+vtoL/VGlhxDdMPNCCh1FqBhtDQicxVrFzBsQSDefcqJjbTh+1E=', 'OWN', 'AAMfUf4bMP1ThymoWYhNAylZuM0S7vZvvElWkKaBcHoMVuRvR1YtpIZnxERNX+Gd+vtoL/VGlhxDdMPNCCh1FqBhtDQicxVrFzBsQSDefcqJjbTh+1E=', 'SERIALPART', 'product', NULL, '2024-12-05T00:00:00.000Z', 'PERSISTENT', 'Asset successfully created in the system.', 'default_policy', NULL, 'CONTRACT_AGR_001', 'partType'),
                  ('urn:uuid:e22fa027-e2e9-473b-9140-03e533c68f0f', NULL, 'e22fa027-e2e9-473b-9140-03e533c68f0f', bpnB, 'BMW', 'G61', 'DEU', NULL, 'i5 xDrive40', 'OK', 'AAMzHX3vau6eUhry2mL2NJWV0mLLnha92w4IPkQynA0SljawY9Kt1IOmAkfs9OT9htZIadHgl7hS70RYcUg+UwsZZflc/pOiqiH9TZk11/t34hUYknc=', 'OWN', 'AAMzHX3vau6eUhry2mL2NJWV0mLLnha92w4IPkQynA0SljawY9Kt1IOmAkfs9OT9htZIadHgl7hS70RYcUg+UwsZZflc/pOiqiH9TZk11/t34hUYknc=', 'SERIALPART', 'product', NULL, '2024-12-11T00:00:00.000Z', 'PERSISTENT', 'Asset successfully created in the system.', 'default_policy', NULL, 'CONTRACT_AGR_001', 'partType'),
                  ('urn:uuid:e42a27bf-f7c0-4e5c-8fbf-530b0ecb3826', NULL, 'e42a27bf-f7c0-4e5c-8fbf-530b0ecb3826', bpnB, 'BMW', 'G61', 'DEU', NULL, 'i5 M60 xDrive', 'OK', 'AAJWKWd63reVxRfDoor9teYxcG3uHtwteRH1SQkLtJSPTXrFHTobS2/EyB4E6uAmMGLLnP+wUHQFb5JVpm8gq2YZmr0xZktkABKxJYi8Y9hGKPj/uJk=', 'OWN', 'AAJWKWd63reVxRfDoor9teYxcG3uHtwteRH1SQkLtJSPTXrFHTobS2/EyB4E6uAmMGLLnP+wUHQFb5JVpm8gq2YZmr0xZktkABKxJYi8Y9hGKPj/uJk=', 'SERIALPART', 'product', NULL, '2024-12-16T00:00:00.000Z', 'PERSISTENT', 'Asset successfully created in the system.', 'default_policy', NULL, 'CONTRACT_AGR_001', 'partType')
            ...
            IF NOT EXISTS (
                SELECT 1 FROM assets_as_built_childs
                WHERE asset_as_built_id = 'urn:uuid:0bb07747-9774-47a7-bcb7-6c4388745585'
                  AND id = 'urn:uuid:53f3371e-81e2-4bea-953e-d683688550cc'
        ) THEN
            INSERT INTO assets_as_built_childs (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:0bb07747-9774-47a7-bcb7-6c4388745585', 'urn:uuid:53f3371e-81e2-4bea-953e-d683688550cc', '53f3371e-81e2-4bea-953e-d683688550cc');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_childs
            WHERE asset_as_built_id = 'urn:uuid:8ea0e758-af77-4932-8f09-724f14ca7125'
              AND id = 'urn:uuid:9a8ab85d-58be-4045-8caa-8fab8fe511e6'
        ) THEN
            INSERT INTO assets_as_built_childs (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:8ea0e758-af77-4932-8f09-724f14ca7125', 'urn:uuid:9a8ab85d-58be-4045-8caa-8fab8fe511e6', '9a8ab85d-58be-4045-8caa-8fab8fe511e6');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_childs
            WHERE asset_as_built_id = 'urn:uuid:94617c47-692f-40e6-ac15-75dca036477b'
              AND id = 'urn:uuid:4d2da80a-f483-4c2b-8207-8d794079dee7'
        ) THEN
            INSERT INTO assets_as_built_childs (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:94617c47-692f-40e6-ac15-75dca036477b', 'urn:uuid:4d2da80a-f483-4c2b-8207-8d794079dee7', '4d2da80a-f483-4c2b-8207-8d794079dee7');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_childs
            WHERE asset_as_built_id = 'urn:uuid:e22fa027-e2e9-473b-9140-03e533c68f0f'
              AND id = 'urn:uuid:393f1ebb-49d4-4fe8-8ffc-7d85baa2f068'
        ) THEN
            INSERT INTO assets_as_built_childs (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:e22fa027-e2e9-473b-9140-03e533c68f0f', 'urn:uuid:393f1ebb-49d4-4fe8-8ffc-7d85baa2f068', '393f1ebb-49d4-4fe8-8ffc-7d85baa2f068');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_childs
            WHERE asset_as_built_id = 'urn:uuid:e42a27bf-f7c0-4e5c-8fbf-530b0ecb3826'
              AND id = 'urn:uuid:78673ce4-9037-4f34-9014-9797080e768e'
        ) THEN
            INSERT INTO assets_as_built_childs (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:e42a27bf-f7c0-4e5c-8fbf-530b0ecb3826', 'urn:uuid:78673ce4-9037-4f34-9014-9797080e768e', '78673ce4-9037-4f34-9014-9797080e768e');
        END IF;
        ...
        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_parents
            WHERE asset_as_built_id = 'urn:uuid:53f3371e-81e2-4bea-953e-d683688550cc'
              AND id = 'urn:uuid:0bb07747-9774-47a7-bcb7-6c4388745585'
        ) THEN
            INSERT INTO assets_as_built_parents (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:53f3371e-81e2-4bea-953e-d683688550cc', 'urn:uuid:0bb07747-9774-47a7-bcb7-6c4388745585', '0bb07747-9774-47a7-bcb7-6c4388745585');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_parents
            WHERE asset_as_built_id = 'urn:uuid:9a8ab85d-58be-4045-8caa-8fab8fe511e6'
              AND id = 'urn:uuid:8ea0e758-af77-4932-8f09-724f14ca7125'
        ) THEN
            INSERT INTO assets_as_built_parents (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:9a8ab85d-58be-4045-8caa-8fab8fe511e6', 'urn:uuid:8ea0e758-af77-4932-8f09-724f14ca7125', '8ea0e758-af77-4932-8f09-724f14ca7125');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_parents
            WHERE asset_as_built_id = 'urn:uuid:4d2da80a-f483-4c2b-8207-8d794079dee7'
              AND id = 'urn:uuid:94617c47-692f-40e6-ac15-75dca036477b'
        ) THEN
            INSERT INTO assets_as_built_parents (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:4d2da80a-f483-4c2b-8207-8d794079dee7', 'urn:uuid:94617c47-692f-40e6-ac15-75dca036477b', '94617c47-692f-40e6-ac15-75dca036477b');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_parents
            WHERE asset_as_built_id = 'urn:uuid:393f1ebb-49d4-4fe8-8ffc-7d85baa2f068'
              AND id = 'urn:uuid:e22fa027-e2e9-473b-9140-03e533c68f0f'
        ) THEN
            INSERT INTO assets_as_built_parents (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:393f1ebb-49d4-4fe8-8ffc-7d85baa2f068', 'urn:uuid:e22fa027-e2e9-473b-9140-03e533c68f0f', 'e22fa027-e2e9-473b-9140-03e533c68f0f');
        END IF;

        IF NOT EXISTS (
            SELECT 1 FROM assets_as_built_parents
            WHERE asset_as_built_id = 'urn:uuid:78673ce4-9037-4f34-9014-9797080e768e'
              AND id = 'urn:uuid:e42a27bf-f7c0-4e5c-8fbf-530b0ecb3826'
        ) THEN
            INSERT INTO assets_as_built_parents (asset_as_built_id, id, id_short)
            VALUES ('urn:uuid:78673ce4-9037-4f34-9014-9797080e768e', 'urn:uuid:e42a27bf-f7c0-4e5c-8fbf-530b0ecb3826', 'e42a27bf-f7c0-4e5c-8fbf-530b0ecb3826');
        END IF;
