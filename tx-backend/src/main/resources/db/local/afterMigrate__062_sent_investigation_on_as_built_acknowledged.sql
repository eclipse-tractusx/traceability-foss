...
values
    (${investigationNotificationSentId3a}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', null                     , ${bpnSupplier2}, ${bpnOwn}, ${investigationSentId3}, current_timestamp + interval '4 days', 3       , 'Hella'        , 'Philips'     , '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 3     , current_timestamp - interval '3 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', true);
