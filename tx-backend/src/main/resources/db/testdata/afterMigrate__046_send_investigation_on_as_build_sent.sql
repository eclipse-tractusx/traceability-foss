...
-- This creates an investigation in state SENT in Severity Critical for asBuilt asset Osram Front Right-AX400 which is sent from BPNL000000000001 to BPNL000SUPPLIER2

---
insert into investigation
    (id                 , bpn               , close_reason, created                               , description                                                            , status, side    , accept_reason, decline_reason, updated                              , error_message)
values
    (${investigationId4}, 'BPNL000000000001', null        , current_timestamp - interval '2 hours', 'Investigation on Osram Front Right-AX400 due to excessive brightness.', 'SENT', 'SENDER', null         , null          , current_timestamp - interval '1 hour', null);
...
values
    (${investigationNotificationId4}, ${assetAsBuiltId04});
...
values
    (${investigationId4}, ${assetAsBuiltId04});
