...
values
    (${alertId4}, 'BPNL000000000001 ', null        , current_timestamp, 'Alert about Left Headlights', 'SENT', 'SENDER', null         , null          , current_timestamp, null);
...
values
    (${alertNotificationId4}, ${assetAsBuiltId01});
