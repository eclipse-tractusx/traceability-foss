...
values
    ...
    (${assetAsPlannedId05}, ${assetAsPlannedId01}, 'H-LeftTailLight'),  -- Phillips Rear Left-C4R isChildOf Xenon Left-Taillights
    (${assetAsPlannedId04}, ${assetAsPlannedId02}, 'H-RightTailLight'), -- Osram Rear Right-ZX500 isChildOf Xenon Right-Taillights
    (${assetAsPlannedId06}, ${assetAsPlannedId02}, 'H-RightTailLight'), -- Phillips Rear Right-C4R isChildOf Xenon Right-Taillights
