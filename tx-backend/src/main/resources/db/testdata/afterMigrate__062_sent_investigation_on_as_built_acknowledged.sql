...
values
    (${investigationNotificationSentId3b}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', null                     , 'BPNL000SUPPLIER2', 'BPNL000000000001', ${investigationSentId3}, current_timestamp + interval '4 days', 3       , 'Philips'      , 'Hella'     , '8925f21f-09eb-4789-81fb-ec221e9e1561', 3      , current_timestamp - interval '3 days', current_timestamp - interval '1 hour', '207ba6cf-217b-401d-a5da-69cac8b154a5', false);
