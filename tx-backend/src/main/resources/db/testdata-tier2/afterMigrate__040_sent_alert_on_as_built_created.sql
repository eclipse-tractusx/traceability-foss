...
values
    (${alertSentId1}, 'BPNL000SUPPLIER1', null        , current_timestamp, 'Alert about Turning Lights', 'CREATED', 'SENDER', null         , null          , null   , null);
...
values
    (${alertNotificationSentId1}, ${alertSentId1}, null                 , null   , 'null'                   , 'BPNL000SUPPLIER1', 'BPNL000000000001', current_timestamp + interval '1 month', 0       , 'Osram'        , 'Hella'     , ${alertNotificationSentId1}, 0     , current_timestamp - interval '1 seconds', current_timestamp, '42e28782-bf4c-45a2-82b7-1757aa4b8772', true);
