...
values
    (${alertSentId2}, 'BPNL000SUPPLIER1', null        , current_timestamp - interval '2 days', 'Alert about Left O Light Bulbs', 'SENT', 'SENDER', null         , null          , current_timestamp, null);
...
values
    (${alertNotificationSentId2}, ${alertSentId2}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', 'null'                   , 'BPNL000SUPPLIER1', 'BPNL000000000001', current_timestamp + interval '1 month', 1       , 'Osram'         , 'Hella'     , ${alertNotificationSentId2}, 1     , current_timestamp - interval '1 day', current_timestamp, '2cf84b7c-5e42-46f2-8869-12b053b9a276', true);
