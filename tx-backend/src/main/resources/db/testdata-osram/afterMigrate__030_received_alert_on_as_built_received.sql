...
values
    (${alertReceivedId1}, ${bpnSupplier21}, null        , current_timestamp - interval '2 days', 'Alert about Packaging for turning light', 'RECEIVED', 'RECEIVER', null         , null          , null   , null);
...
values
    (${alertNotificationReceivedId1}, ${alertReceivedId1}, null                 , null   , 'ded38f08-1b9c-497d-b994-6feba92b7f41',  ${bpnSupplier21}, ${bpnOwn}, current_timestamp + interval '1 month', 2       , 'Petersmeier'  , 'Osram'     , 'ded38f08-1b9c-497d-b994-6feba92b7f41', 2   , current_timestamp - interval '1 day', null   , '7d0891d2-4940-4802-b0bc-cc30f9e94e76', false);
