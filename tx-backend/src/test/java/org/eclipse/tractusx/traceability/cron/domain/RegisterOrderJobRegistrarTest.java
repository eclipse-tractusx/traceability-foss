...
class RegisterOrderJobRegistrarTest {
    ...
    @InjectMocks
    private RegisterOrderJobRegistration jobRegistration;
    ...
    void testGetCronExpression() {
        ...
        when(triggerConfiguration.getCronExpressionRegisterOrderTTLReached()).thenReturn("0 0 * * * *");
