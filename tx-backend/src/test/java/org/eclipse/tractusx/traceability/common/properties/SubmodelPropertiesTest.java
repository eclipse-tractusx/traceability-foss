...
@EnableConfigurationProperties(value = SubmodelProperties.class)
class SubmodelPropertiesTest {

    @Autowired
    private SubmodelProperties submodelProperties;

    @Test
    void test_submodelProperties() {
        //GIVEN
        //WHEN
        //THEN
