...
class PublishAssetJobRegistrationTest {
    ...
    @InjectMocks
    private PublishAssetJobRegistration publishAssetJobRegistrar;
    ...
    void testGetCronExpression() {
        ...
        when(triggerConfiguration.getCronExpressionPublishAssets()).thenReturn("0 0 * * * *");

        assertThat(publishAssetJobRegistrar.getCronExpression(config)).isEqualTo("0 0 * * * *");
    }
