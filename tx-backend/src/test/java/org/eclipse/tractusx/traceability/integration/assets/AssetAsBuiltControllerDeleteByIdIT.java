...
class AssetAsBuiltControllerDeleteByIdIT extends IntegrationTestSpecification {
    ...
    void shouldDeleteAssetById() throws JoseException {
        ...
        final String assetId = "urn:uuid:d387fa8e-603c-42bd-98c3-4d87fef8d2bb";
        final BomLifecycle bomLifecycle = BomLifecycle.AS_BUILT;
