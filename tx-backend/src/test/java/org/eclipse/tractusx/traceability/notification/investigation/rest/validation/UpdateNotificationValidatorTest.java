...
package org.eclipse.tractusx.traceability.notification.investigation.rest.validation;
...
import org.eclipse.tractusx.traceability.notification.application.notification.validation.UpdateNotificationValidator;
...
class UpdateNotificationValidatorTest {

    @Test
    @DisplayName("No Validation Success for invalid Reason")
    void testUnsuccessfulValidationForInvalidReason() {

        UpdateNotificationStatusRequest acknowledged = UpdateNotificationStatusRequest.ACKNOWLEDGED;
