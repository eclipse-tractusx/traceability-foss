...
class AASCleanupJobRegistrationTest {
    ...
    @InjectMocks
    private AASCleanupJobRegistration jobRegistration;


    @Test
    void testGetJobName() {
        assertThat(jobRegistration.getJobName()).isEqualTo("aas-cleanup");
    }
    ...
    void testGetCronExpression() {
        ...
        when(triggerConfiguration.getCronExpressionAASCleanup()).thenReturn("0 0 * * * *");
