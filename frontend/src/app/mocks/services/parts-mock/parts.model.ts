...
export const mockBmwAssets = [
  {
    ...
    parentRelations: [{ id: 'urn:uuid:55c376ed-e39d-4525-96e6-71f3def7ae41', idShort: '--' }],
    activeAlert: false,
  ...
  },
  {
    ...
    semanticModel: {
      ...
      nameAtCustomer: 'myname_atcustomer',
    },
    owner: Owner.OWN,
    childRelations: [],
    parentRelations: [],
...

{
...

  {
    ...
    idShort: '--',
    semanticModelId: 'mysemanticModelId7',
    manufacturerId: 'BPNL00000003AYRE',
    manufacturerName: 'OEM A',
    semanticModel: {
...

  {
    ...
    idShort: '--',
    semanticModelId: 'mysemanticmodelId8',
    manufacturerId: 'BPNL00000003AYRE',
    manufacturerName: 'OEM A',
    semanticModel: {
  ...
  },
  {
    ...
    idShort: '--',
    semanticModelId: 'mysemanticmodelId9',
    manufacturerId: 'BPNL00000003AYRE',
    manufacturerName: 'OEM A',
    semanticModel: {
  ...
  },
  {
    ...
    idShort: '--',
    semanticModelId: 'mysemanticmodelId10',
    manufacturerId: 'BPNL00000003AYRE',
    manufacturerName: 'OEM A',
    semanticModel: {
      nameAtManufacturer: 'Vehicle Fully Electric',
  ...
  },
  {
    ...
    idShort: '--',
    semanticModelId: 'mysemanticModelId11',
    manufacturerId: 'BPNL00000003AYRE',
    manufacturerName: 'OEM A',
    semanticModel: {
      nameAtManufacturer: 'Vehicle Fully Electric',
...
const MockEmptyPart: PartResponse = {
  ...
  idShort: '--',
  semanticModelId: 'myEmptysemanticmodelid',
  manufacturerId: 'BPNL00000003AYRE',
  manufacturerName: 'OEM A',
  semanticModel: {
    manufacturingDate: '2000-01-01T00:00:00Z',
    manufacturingCountry: 'MockPartEmpty',
    manufacturerPartId: 'AA-00',
    customerPartId: '--',
    nameAtManufacturer: 'myname_atmanufacturer',
    nameAtCustomer: 'myname_atcustomer',
  },
  owner: Owner.OWN,
  childRelations: [],
