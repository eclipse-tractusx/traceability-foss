...
import { BpnConfigResponse, Contract, ContractState } from '@page/admin/core/admin.model';
...
export const getContracts = (): PaginationResponse<Contract> => {
  return {
    page: 0,
    pageSize: 10,
    totalItems: 12,
    ...
    content: [
      {
        ...
        "creationDate": 1708951.087000000,
        "endDate": null,
