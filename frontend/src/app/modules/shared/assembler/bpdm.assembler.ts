...
export class BpdmAssembler {
  ...
  public static assembleLegalEntity(legalEntityResponse: LegalEntityResponse): LegalEntity {
    ...
    let mappedPart
      ...
      // identifiers: legalEntityResponse.identifiers,
      legalShortName: legalEntityResponse.legalShortName,
      // legalForm: legalEntityResponse.legalForm,
      // states: legalEntityResponse.states,
      // classifications: legalEntityResponse.classifications,
      // relations: legalEntityResponse.relations,
