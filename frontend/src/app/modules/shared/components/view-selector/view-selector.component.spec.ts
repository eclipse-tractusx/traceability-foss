...
describe('AppViewSelector', () => {
  it('should render regular button', async () => {
    await renderComponent(`<app-view-selector (click)="clickHandler">Test</app-view-selector>`, {
  ...
  it('should click regular button', async () => {
    ...
    const fixture = await renderComponent(`<app-view-selector (click)="clickHandler($event)">Test</app-button>`, {
      declarations: [ButtonComponent],
      imports: [SharedModule, TemplateModule],
      componentProperties: {
        clickHandler,
  ...
  it('should render accent button', async () => {
    await renderComponent(`<app-view-selector color="accent">Test</app-button>`, {
      declarations: [ButtonComponent],
      imports: [SharedModule, TemplateModule],
    });
  ...
  it('should render warn button', async () => {
    await renderComponent(`<app-view-selector color="warn">Test</app-button>`, {
      declarations: [ButtonComponent],
      imports: [SharedModule, TemplateModule],
    });
  ...
  it('should render enabled button', async () => {
    await renderComponent(`<app-view-selector [isDisabled]="false">Test</app-button>`, {
      declarations: [ButtonComponent],
      imports: [SharedModule, TemplateModule],
    });
  ...
  it('should render disabled button', async () => {
    await renderComponent(`<app-view-selector [isDisabled]="true">Test</app-button>`, {
      declarations: [ButtonComponent],
      imports: [SharedModule, TemplateModule],
    });
