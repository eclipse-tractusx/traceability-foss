...
Given(/^user logged in as "supervisor"$/, () => {
  ...
  console.log(Cypress.env('CYPRESS_SUPERVISOR_LOGIN'), 'Cypress.env(CYPRESS_SUPERVISOR_LOGIN');
  console.log(Cypress.env('SUPERVISOR_LOGIN'), 'Cypress.env(SUPERVISOR_LOGIN)');
