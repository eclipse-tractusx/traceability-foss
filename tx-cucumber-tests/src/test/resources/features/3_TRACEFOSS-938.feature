...
Feature: ⭐[TEST] Update Quality Investigation (over EDC)
	...
	@TRACEFOSS-1862 @TRACEFOSS-3128 @TRACEFOSS-2910 @TEST-1217 @TRACEFOSS-2715 @TEST-904 @TRACEFOSS-1920 @TRACEFOSS-1673 @TRACEFOSS-1101 @INTEGRATION_TEST @[QualityInvestigation]
