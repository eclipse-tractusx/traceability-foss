...
DELETE_E2E_RESOURCES=(
              ...
              "$ARGO_E2E_A_REGISTRY/resource?group=apps&force=false&orphan=false&resourceName=tracex-registry-e2e-a-registry&version=v1&kind=Deployment&namespace=product-traceability-foss"
              ...
              "$ARGO_E2E_B_REGISTRY/resource?group=apps&force=false&orphan=false&resourceName=tracex-registry-e2e-b-registry&version=v1&kind=Deployment&namespace=product-traceability-foss"
            )
DELETE_INT_RESOURCES=(
              ...
              "$ARGO_INT_A_REGISTRY/resource?group=apps&force=false&orphan=false&resourceName=tracex-registry-int-a-registry&version=v1&kind=Deployment&namespace=product-traceability-foss"
              ...
              "$ARGO_INT_B_REGISTRY/resource?group=apps&force=false&orphan=false&resourceName=tracex-registry-int-b-registry&version=v1&kind=Deployment&namespace=product-traceability-foss"
            )
